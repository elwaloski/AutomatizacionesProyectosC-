    ...
    <body>
        ...
        <div class="sidenav">
            ...
            <a class="tablink" href="#" onclick="openPage('archives', this, 'white', '#565656', 'groove');">
                <i class="fa fa-history" id="tablinkicon" style="color:currentcolor; margin:5% 5% 5% 10%"></i> Archivos
            </a>
                          ...
                          <div style="margin-bottom: -6%; margin-left: 40%;">
                            <span style="color: darkgray; font-size: 17px;">
                                <i class="fa fa-clock-o" style="color:currentcolor; margin: 2% 2% 0% 29%; font-size: 25px;"></i>
                                    Tiempo tomado __execution_time__ Seg.
                            </span>
                          </div>
                          <div>
                              ...
                              <div style="display: flex;">
                                <span class="total_count__label">Casos de Prueba</span>
                              </div>
                          </div>
                          <div>
                              ...
                              <div style="margin-top: -11%;">
                                  <div class="card__footer">
                                    <div class="card__footer-section">
                                      ...
                                      <div class="footer-section__label">Pasados</div>
                                    </div>
                                    <div class="card__footer-section">
                                      <div class="footer-section__data" style="color:#fc6766">__fail__</div>
                                      <div class="footer-section__label">Fallado</div>
                                    </div>
                                    <div class="card__footer-section">
                                    ...
                                    <div class="card__footer-section">
                                      ...
                                      <div class="footer-section__label">Reitentos</div>
                                    </div>
                                  </div>
                              </div>
                          </div>
            ...
            function executeDataTable(tabname, sortCol) {
                ...
                $(tabname).DataTable({
                    ...
                    buttons: [
                    {
                        ...
                        filename: function() {
                            return fileTitle + '-' + new Date().toLocaleDateString('es-ES', {
                            day: '2-digit',
                            month: 'long',
                            year: 'numeric'
                        }).replace(/\s/g, '-');
